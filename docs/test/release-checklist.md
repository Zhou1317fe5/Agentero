...
| # | 界面 | 操作 | 预期 | 结果 |
|---|---|---|---|---|
| 7.2.1 | 中间栏·PDF | 拖选一段文字 | 仅选中文字显示平滑蓝色选区 + 操作菜单（高亮 / 提问 / 加入对话 / 翻译，无批注按钮）+ 页右缘竖向评论入口；不出现整页 / 大块 PDF 蓝色矩形框选 | ☐ |
| 7.2.2 | 菜单 | 选 **高亮** | 高亮保留；磁盘 `marks/` 有记录；**原始 PDF 字节不变** | ☐ |
| 7.2.3 | 页右缘 | hover 竖向评论入口 → 移走 → 再按下写 comment | hover 展开、移走缩回；按下后就地编辑且选区变为高亮；保存后页右缘常驻评论卡 | ☐ |
