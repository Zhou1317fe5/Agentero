...
| # | 界面 | 操作 | 预期 | 结果 |
|---|---|---|---|---|
| 7.2.1 | 中间栏·PDF | 拖选一段文字 | 仅选中文字显示平滑蓝色选区 + 操作菜单（高亮 / 提问 / 翻译，无批注按钮；提问图标为 PDF Ask Agent logo）+ 选区右下角「加入对话」pill + 页右缘竖向评论入口；不出现整页 / 大块 PDF 蓝色矩形框选 | ☐ |
...
| 7.2.7 | 选区右下角 | 点 **加入对话** pill → 在 Agent 输入问题发送 | Composer 有选区 chip；发送后选区旁出现**对话卡片**页边针（`kind: ask`，非视觉批注）；悬停/点开可见本轮问答 | ☐ |
